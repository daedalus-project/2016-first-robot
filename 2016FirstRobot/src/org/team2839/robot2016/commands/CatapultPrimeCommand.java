 ...
 *
 */
public class CatapultPrimeCommand extends Command {

    public CatapultPrimeCommand() {
    ...
    protected void execute() {
    	Subsystems.catapult.setSpeed(Constants.STOPBAR_PRIME_SPEED);
    }

    // Make this return true when this Command no longer needs to run execute()
    protected boolean isFinished() {
        return Subsystems.catapult.primed();
    }
